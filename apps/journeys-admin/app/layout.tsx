...
import { NextAppDirEmotionCacheProvider } from '../src/libs/NextAppDirEmotionCacheProvider'

import JourneysAdminApp from './ClientLayout'
    ...
    <html lang="en">
      ...
      <body>
        <ThemeRegistry options={{ key: 'mui' }}>
          <ApolloWrapper>
            <JourneysAdminApp>{children}</JourneysAdminApp>
          </ApolloWrapper>
        </ThemeRegistry>
      </body>
    </html>
