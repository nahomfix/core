...
export function transformArclightMediaComponentToVideo(
  ...
  return {
    ...
    metadataLanguageId,
    title: mediaComponent.title,
    snippet: mediaComponent.shortDescription,
    description: mediaComponent.longDescription,
    studyQuestions: mediaComponent.studyQuestions,
